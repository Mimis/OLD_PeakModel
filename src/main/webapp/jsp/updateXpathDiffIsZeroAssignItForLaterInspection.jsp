...
<html>
<head>
	<title>DETAIL LINKS xpath difference is ZERO...LEAVE IT INTO THE DB FOR LATER INSPECTION-ASSIGN NAV_PAT==4 AND  MAKE INVALID ITS JOBS</title>
</head>
<body>
<%
	try {
		...
		*/
		...
		%>
			Database successfully Updated!  <br>DETAIL LINKS xpath difference is ZERO...LEAVE IT INTO THE DB FOR LATER INSPECTION-
			<br>ASSIGN NAV_PAT==4 AND  MAKE INVALID ITS JOBS<br>  
		<%
