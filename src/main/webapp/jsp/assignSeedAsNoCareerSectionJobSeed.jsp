...
<html>
<head>
	<title>Updating Database Assign as Seed with No Career Section and Jobs</title>
</head>
<body>
<%
	try {
	    ...
	    */
		...
		if(seed_id != null){
			ps = con.prepareStatement("update seeds set crawled = 3 where id=?");
		...
		%>
			Database successfully Updated! <br>Assign the Seed as SEED WITH NO CAREER SECTION OR JOBS (CRAWLED=3)!!!
		<%
