...
<%
	...
	/*
	Find which Database to Update based on the database Code
		code=0 ==> 'ask4energy'
		code=1 ==> 'ask4dutch'
	*/	
	...
	//if(database_code.equals("0")){
	//	database = "ask4energy";
	//}
	//else if(database_code.equals("1")){
	//	database = "ask4dutch";	
	//}
%>
...
<html>
<head>
	<title>Updating Database delete all the job posts and the navigation patterns and assign the resource page's navigation field to "3"'</title>
</head>
<body>
<%
	try {
	    ...
	    */
		...
		if(form_id != null){
			ps = con.prepareStatement("update form_table set navigated = 3 where id=?");
